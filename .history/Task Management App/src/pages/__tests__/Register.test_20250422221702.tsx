...
describe("Register component", () => {
  ...
  it("submits form successfully", async () => {
    ...
    fireEvent.click(screen.getAllByText('สมัครสมาชิก')[1]); // but less clear
  ...
  it("shows backend error message", async () => {
    ...
    await waitFor(() => {
        expect(screen.getByText((content) => content.includes('เกิดข้อผิดพลาดในการสมัครสมาชิก'))).toBeInTheDocument();
