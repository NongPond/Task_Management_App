describe('Task Manager App', () => {
  ...
  it('Registers a new user successfully', () => {
    ...
    // ใช้ selector ที่มีความเฉพาะเจาะจง
    cy.get('input[name="email"]', { timeout: 10000 }).should('exist').type(testEmail);
    cy.get('input[name="password"]', { timeout: 10000 }).should('exist').type(testPassword);
