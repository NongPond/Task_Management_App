describe('Task Manager App', () => {
  const testEmail = '111111000001@gmail.com';
  const testPassword = 'Pondza1234567891234546';

  it('Registers a new user successfully', () => {
    cy.visit('/register');

    cy.get('input[placeholder="you@example.com"]').type('111111000001@gmail.com');
    cy.get('input[placeholder="••••••••"]')('Pondza123456789');
  ...
  it('Fails login with wrong password', () => {
    cy.visit('/');
    cy.get('input[placeholder="you@example.com"]').type('godpondzaผฟ@gmail.com');
    cy.get('input[placeholder="••••••••"]').type('GodPondza12zaza');
