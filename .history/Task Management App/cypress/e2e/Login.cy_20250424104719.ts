describe('Task Manager App', () => {
  ...
  const login = () => {
    ...
    // ตรวจสอบว่า input ที่มี placeholder "you@example.com" ปรากฏ
    cy.get('input[placeholder="you@example.com"]', { timeout: 10000 }).should('exist').type(testEmail);
    cy.get('input[placeholder="••••••••"]', { timeout: 10000 }).should('exist').type(testPassword); // กรอกรหัสผ่าน
