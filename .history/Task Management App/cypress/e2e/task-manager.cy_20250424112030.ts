describe('Task Manager App', () => {
  ...
  it('Edits a task', () => {
    ...
    cy.get('[data-testid="email-input"], input[name="email"], input[placeholder="you@example.com"], input[aria-label="Email"]')
  .first()
  .type('111111000001@gmail.com');

// กรอกรหัสผ่านด้วย fallback เช่นกัน
    cy.get('[data-testid="password-input"], input[name="password"], input[placeholder="••••••••"], input[aria-label="Password"]')
    .first()
    ...
    // Check for the updated task name
