it('Creates a task, edits it, and saves the changes', () => {
  ...
  // Step 3: Verify the created task appears in the list
  cy.contains(taskTitle).should('exist'); // Check if the task appears in the list after creation
  ...
  // Step 6: Verify the updated task appears in the list with the new title
