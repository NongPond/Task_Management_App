describe('Task Manager App', () => {
  ...
  it('Logs in with correct credentials', () => {
    ...
    // Wait for login and check the correct redirection
    cy.wait('@login');  // Ensure the login request has completed
    cy.url().should('include', '/tasks');  // Correct path for tasks page
  });
